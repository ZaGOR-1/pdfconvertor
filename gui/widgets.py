...
class ThemeToggleButton(ctk.CTkButton):
    ...
    def __init__(self, master, on_toggle: Optional[Callable] = None, **kwargs):
        """
        Ініціалізація кнопки перемикання теми.
        
        Args:
            master: Батьківський віджет
            on_toggle: Callback при перемиканні теми
            **kwargs: Додаткові параметри
        """
        ...
        default_kwargs = {
            ...
            "height": 36,
            "font": ctk.CTkFont(size=12, weight="bold"),
            "fg_color": ("#495057", "#2b2b2b"),
            "hover_color": ("#343a40", "#3b3b3b"),
            "text_color": ("#ffffff", "#dce4ee"),
            "border_width": 2,
            "border_color": ("#212529", "#495057"),
            "corner_radius": 6,
    ...
    def _toggle_theme(self):
        ...
        if self.on_toggle:
            self.on_toggle(self.current_theme)
